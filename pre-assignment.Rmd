...
# Prediction using decomposition and linear regression
```{r}
#trend
...
plot(c(decompose$x, overall_prediction), type="l", ylab="coal usage",
     main="history and prediction")
plot(overall_prediction, type="l", main="prediction for next year",
     ylab="coal usage")
overall_prediction
```